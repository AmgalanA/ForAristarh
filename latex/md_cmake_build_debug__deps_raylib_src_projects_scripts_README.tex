Here are dependency-\/less build scripts for raylib projects.\hypertarget{md_cmake_build_debug__deps_raylib_src_projects_scripts_README_autotoc_md185}{}\doxysubsection{Dependencies}\label{md_cmake_build_debug__deps_raylib_src_projects_scripts_README_autotoc_md185}
The scripts, as mentioned above, do not have dependencies. There\textquotesingle{}s one exception to this however, and that is Windows, because Windows doesn\textquotesingle{}t have a built-\/in C compiler. On Windows, you\textquotesingle{}ll need to install \href{https://visualstudio.microsoft.com/downloads/\#visual-studio-community-2017}{\texttt{ Visual Studio}} or the \href{https://visualstudio.microsoft.com/downloads/\#build-tools-for-visual-studio-2017}{\texttt{ build tools}}. If you didn\textquotesingle{}t install them in the default location, write your changes around line 38 of \href{build-windows.bat}{\texttt{ {\ttfamily build-\/windows.\+bat}}}.\hypertarget{md_cmake_build_debug__deps_raylib_src_projects_scripts_README_autotoc_md186}{}\doxysubsection{Script customization}\label{md_cmake_build_debug__deps_raylib_src_projects_scripts_README_autotoc_md186}
...
\end{DoxyItemize}\hypertarget{md_cmake_build_debug__deps_raylib_src_projects_scripts_README_autotoc_md187}{}\doxysubsection{Compilation flags}\label{md_cmake_build_debug__deps_raylib_src_projects_scripts_README_autotoc_md187}
...
\end{DoxyItemize}\hypertarget{md_cmake_build_debug__deps_raylib_src_projects_scripts_README_autotoc_md188}{}\doxysubsection{Command line arguments}\label{md_cmake_build_debug__deps_raylib_src_projects_scripts_README_autotoc_md188}
...
\end{DoxyItemize}\hypertarget{md_cmake_build_debug__deps_raylib_src_projects_scripts_README_autotoc_md189}{}\doxyparagraph{Examples}\label{md_cmake_build_debug__deps_raylib_src_projects_scripts_README_autotoc_md189}
\tabulinesep=1mm
