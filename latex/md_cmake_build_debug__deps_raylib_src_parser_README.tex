...
Check {\ttfamily raylib\+\_\+parser.\+c} for details about those structs.\hypertarget{md_cmake_build_debug__deps_raylib_src_parser_README_autotoc_md171}{}\doxysection{Command Line}\label{md_cmake_build_debug__deps_raylib_src_parser_README_autotoc_md171}
...
\end{DoxyCode}
\hypertarget{md_cmake_build_debug__deps_raylib_src_parser_README_autotoc_md172}{}\doxysection{Constraints}\label{md_cmake_build_debug__deps_raylib_src_parser_README_autotoc_md172}
...
\end{DoxyItemize}\hypertarget{md_cmake_build_debug__deps_raylib_src_parser_README_autotoc_md173}{}\doxysection{Additional notes}\label{md_cmake_build_debug__deps_raylib_src_parser_README_autotoc_md173}
This parser {\itshape could} work with other C header files if mentioned constraints are followed.

This parser {\bfseries{does not require {\ttfamily $<$string.\+h$>$} library}}, all data is parsed directly from char buffers.\hypertarget{md_cmake_build_debug__deps_raylib_src_parser_README_autotoc_md174}{}\doxysubsection{LICENSE\+: zlib/libpng}\label{md_cmake_build_debug__deps_raylib_src_parser_README_autotoc_md174}
